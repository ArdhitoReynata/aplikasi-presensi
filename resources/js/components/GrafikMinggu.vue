...
export default {
  ...
  methods: {
    async fetchPresensiData() {
      try {
        const response = await axios.get('/presensi-minggu-ini');
            ...
            plugins: {
              ...
              datalabels: {
                ...
                padding: (context) => {
                  ...
                  // Misalnya, mengatur padding berdasarkan nilai data
                  if (value > 30) {
                    return -10;  // Padding lebih besar untuk sektor dengan nilai lebih dari 30
                  } else if (value > 10) {
                    return 20;  // Padding menengah untuk sektor dengan nilai lebih dari 10
                  } else {
                    return 10;  // Padding kecil untuk sektor dengan nilai kurang dari 10
                  }
                },
