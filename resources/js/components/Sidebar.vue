<template>
    <div class="mt-14 lg:mt-16 border-r content-start border-strcolor bg-white p-3 fixed h-screen w-[68px] lg:w-64">
        ...
        <div>
            <button onclick="window.location.href='/admin/kodeqr';" @click="setActiveButton('kodeqr')"
        ...
        <div>
            <button onclick="window.location.href='/admin/karyawan/karyawan';" @click="setActiveButton('karyawan')"
                ...
                <img :src="'/images/person-white.svg'" class="h-7 w-7 p-1 ml-2 group-hover:block hidden" alt="Karyawan">
                <span class="hidden lg:block text-black ml-2 pr-3 font-inter text-sm font-medium group-hover:text-white"
        ...
        <div>
            <button onclick="window.location.href='/admin/laporan';" @click="setActiveButton('laporan')"
                ...
                <img :src="'/images/report-white.svg'" class="h-7 w-7 p-1 ml-2 group-hover:block hidden" alt="Laporan">
                <span class="hidden lg:block text-black ml-2 pr-3 font-inter text-sm font-medium group-hover:text-white"
...
export default {
    ...
    methods: {
        ...
        setActiveButtonBasedOnUrl() {
            ...
            } else if (path.includes('/admin/kodeqr')) {
